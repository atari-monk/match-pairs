import type { AudioState } from 'atari-monk-atom-engine';
import { playSound } from 'atari-monk-atom-engine';
...
function resolveSelection(state: CardInteractionState, audio: AudioState) {
