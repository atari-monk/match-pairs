...
-p /home/atari-monk/atari-monk/project/match-pairs/docs/task/format-commit-msgs.md \
   /home/atari-monk/atari-monk/project/match-pairs/docs/software-requirements-specification/game.md \
...
```sh
proj files bundle \
-o /home/atari-monk/atari-monk/project/match-pairs/docs/prompt/001-proj-init-srs.md \
-p /home/atari-monk/atari-monk/project/match-pairs/docs/task/proj-init-srs.md \
   /home/atari-monk/atari-monk/project/match-pairs/docs/software-requirements-specification-draft/game.md \
   /home/atari-monk/atari-monk/project/match-pairs/docs/template/srs.md
```
...
-p /home/atari-monk/atari-monk/project/match-pairs/docs/task/implement-board.md \
   /home/atari-monk/atari-monk/project/match-pairs/docs/software-requirements-specification/game.md \
   /home/atari-monk/atari-monk/project/match-pairs/docs/guidelines/code.md \
...
-p /home/atari-monk/atari-monk/project/match-pairs/docs/task/005-card-interaction.md \
   /home/atari-monk/atari-monk/project/match-pairs/docs/software-requirements-specification/001-game.md \
   /home/atari-monk/atari-monk/project/match-pairs/docs/guidelines/code.md \
...
-p /home/atari-monk/atari-monk/project/match-pairs/docs/task/007-mobile-screen.md \
   /home/atari-monk/atari-monk/project/match-pairs/docs/software-requirements-specification/002-mobile-screen.md \
